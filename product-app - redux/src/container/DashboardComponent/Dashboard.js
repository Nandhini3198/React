...
this.handlesubmit=this.handlesubmit.bind(this)
    ...
    render() {
        ...
        return (
            <div data-testid="submit2" style={{width:"50rem"}}className="container">
                <button data-testid="category" type="submit" onClick={this.handleClick} name="category" >Add Category</button>
                {this.state.add?<div><input type="text" onChange={this.newCategory} name="category" style={{width:"13rem",float:"left"}} ></input>
                <button  type="submit" data-testid="submit" onClick={this.handlesubmit}>Add</button></div>:"" }
              
              
    
                <div data-testid="submit1"><Graph style={{width:"20rem"}}></Graph></div>
