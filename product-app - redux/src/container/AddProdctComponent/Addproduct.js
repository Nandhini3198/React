        ...
        <div class="container" >
          ...
          <form >
            ...
            <div class="row" style={{ paddingTop: 1 }} >
              <button data-testid="submit1" style={{ marginRight: 16 }, { marginTop: 16 }} onClick={this.handleSubmit} type="submit" value="">Add Product</button>

              <button data-testid="submit" style={{ marginRight: 16 }, { marginTop: 16 }} onClick={this.back} type="submit" value=""> Back</button>
...
export default connect(null,mapPropsToStore)(withRouter(Addproduct));